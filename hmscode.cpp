...
#include<iostream>               // for input output strlem regulation
...
using namespace std;
class doctor;                      //declaration for class doctor
class patient;                     // declaration of class patient
class hospital
{
    public:
   // int id=0,id1=0,
...
class doctor:public hospital            // inheritation of hospital class to doctor
{
    public:
    int docid=0;
    struct doctor1 arr[10] ;
    
    // function to add doctor's entries
    void add_doc_info()
    {
        int i,en;
    ...
    // function to show front page of doctor database
    ...
    void Display()
    {
        ...
        else
        {
         ...
         getch();                                    // To wait for some time until a key is hit
    }

 // function to show doctor's details in doctor database
    ...
    // function to show total number of doctors available in doctor database
...
class patient:public hospital
{
   ...
   void gen_pat_report();
		...
		// function to add patient information in patient database
...
// function to show patient details in patient databse
...
// function to show patient report in patient databse
...
// function to show front page in patient databse
...
// function to show total number of patient in patient databse
...
//function to generate patient report in patient databse
